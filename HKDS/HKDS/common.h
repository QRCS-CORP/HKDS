...
#	elif defined(SYSTEM_COMPILER_GCC)
#		if defined(HKDS_DLL_IMPORT)
#		define HKDS_EXPORT_API __attribute__((dllimport))
#		else
#		define HKDS_EXPORT_API __attribute__((dllexport))
#		endif
#	else
...
/*!
* \def SYSTEM_KECCAK_UNROLLED_PERMUTATION
...
*/
/* #define SYSTEM_KECCAK_UNROLLED_PERMUTATION */
