...
\hypertarget{testutils_8h_source}{}\label{testutils_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/HKDS/HKDSTest/testutils.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/HKDS/HKDSTest/testutils.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ QSCTEST\_TESTUTILS\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ QSCTEST\_TESTUTILS\_H}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{comment}{/*\ \(\backslash\)cond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \textcolor{preprocessor}{\#include\ "{}common.h"{}}}
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00058\ \textcolor{keywordtype}{char}\ qsctest\_get\_char();}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00063\ \textcolor{keywordtype}{char}\ qsctest\_get\_wait();}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00072\ \textcolor{keywordtype}{void}\ qsctest\_hex\_to\_bin(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ hexstr,\ uint8\_t*\ output,\ \textcolor{keywordtype}{size\_t}\ length);}
\DoxyCodeLine{00073\ }
\DoxyCodeLine{00081\ \textcolor{keywordtype}{void}\ qsctest\_print\_hex(\textcolor{keyword}{const}\ uint8\_t*\ input,\ \textcolor{keywordtype}{size\_t}\ inputlen,\ \textcolor{keywordtype}{size\_t}\ linelen);}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00088\ \textcolor{keywordtype}{void}\ qsctest\_print\_safe(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ input);}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00095\ \textcolor{keywordtype}{void}\ qsctest\_print\_line(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ input);}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00102\ \textcolor{keywordtype}{void}\ qsctest\_print\_ulong(uint64\_t\ digit);}
\DoxyCodeLine{00103\ }
\DoxyCodeLine{00109\ \textcolor{keywordtype}{void}\ qsctest\_print\_double(\textcolor{keywordtype}{double}\ digit);}
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00116\ \textcolor{keywordtype}{bool}\ qsctest\_test\_confirm(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ message);}
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00118\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00119\ }
