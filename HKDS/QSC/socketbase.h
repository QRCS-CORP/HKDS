...
#define MAX_ADDRESS_LENGTH INET6_ADDRSTRLEN
...
* \return The number of bytes received from the remote host
*/
QSC_EXPORT_API size_t qsc_socket_receivefrom(qsc_socket* source, char destination[MAX_ADDRESS_LENGTH], size_t destlen, uint16_t port, uint8_t* output, size_t length, qsc_socket_receive_flags flag);
...
* \return The number of bytes sent to the remote host
*/
QSC_EXPORT_API size_t qsc_socket_sendto(qsc_socket* source, const char* destination, size_t destlen, uint16_t port, const uint8_t* input, size_t length, qsc_socket_send_flags flag);
