\doxysection{hkds\+\_\+test.\+h}
\hypertarget{hkds__test_8h_source}{}\label{hkds__test_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/HKDS/HKDSTest/hkds\_test.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/HKDS/HKDSTest/hkds\_test.h}}
\mbox{\hyperlink{hkds__test_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ HKDSTEST\_HKDSTEST\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ HKDSTEST\_HKDSTEST\_H}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{preprocessor}{\#include\ "{}common.h"{}}}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00067\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_a1af209b1a1b1ffbccc86c8a33e0192d4}{hkdstest\_cycle\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00079\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_ad4bf4a9381598686fc4386c7e3b5ab63}{hkdstest\_kat\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00090\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_a204351838e7b29ba63f132e57373bbcb}{hkdstest\_katae\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00101\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_abaceac982222b9a68cdd093478510dff}{hkdstest\_monte\_carlo\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00102\ }
\DoxyCodeLine{00112\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_a437dddcd385ac405ac561bf168818525}{hkdstest\_stress\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00123\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_a49195596923e2fe2a9206129f5b4f440}{hkdstest\_simd\_encrypt\_equivalence\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00134\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{hkds__test_8h_ac3d58b87a9b69092856b5c1222b0ac48}{hkdstest\_simd\_authencrypt\_equivalence\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00135\ }
\DoxyCodeLine{00136\ \textcolor{preprocessor}{\#if\ defined(SYSTEM\_OPENMP)}}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00147\ \textcolor{keywordtype}{bool}\ hkdstest\_parallel\_encrypt\_equivalence\_test(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00148\ }
\DoxyCodeLine{00158\ \textcolor{keywordtype}{bool}\ hkdstest\_parallel\_authencrypt\_equivalence\_test(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00161\ }
\DoxyCodeLine{00170\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{hkds__test_8h_a2050dbbb248c8c3384a5f5ac494ba490}{hkdstest\_test\_run}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00171\ }
